...
def get_category_info():
    ...
    ctype = soup.find("nav", attrs={"class": "page-navigation"}).find("div", attrs={"class": "content"}).find_all("div",
                                                                                                                  attrs={
    ...
    for suptype in ctype[0:3]:
        ...
        category_lis = suptype.find("div", attrs={"class": "menu-container"}).find_all("li",
                                                                                       attrs={"class": "expanded"})
        category_dic = {}
