...
def get_review_data():
    ...
    for p in p_lis:
        if p["ProductId"] in CACHE_DICTION:
            ...
            # https://api.bazaarvoice.com/data/reviews.json?filter=ProductId:{}&filter=rating:gte:4&ReviewText:neq:%22%22&apiversion=5.4&passkey=36ny78oy0qlhkz86za07gl7ep&include=products&Limit=100&ContentLocale=en_US
...
if __name__ == "__main__":
    ...
    fil_header = ["PrimaryName", "SubName", "ProductId", "StarRating", "ReviewCount", "ProductUrl", "SupType", "SubType"]
